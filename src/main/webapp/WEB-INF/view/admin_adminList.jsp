    ...
    <div class="frame_main_content">
        ...
        <div class="frame_main_center">
            <div class="doc_filter">
                ...
                <div class="doc_filter_item">
                    <a href="admin_addAdmin.html" class="doc_btn">新增管理员</a>
                </div>
            </div>
    ...
    $(function () {
        doc.system.adminDataTable = $('#adminTable').dataTable({
            ...
            "fnRowCallback": function (nRow, oData, iDisplayIndex, iDisplayIndexFull) {
                ...
                if (!oData.role) {
                    $('td:eq(5)', nRow).html('<a href="admin_role.html?id=' + oData.id + '">暂无角色,点击添加</a> ');
                } else {
                    $('td:eq(5)', nRow).html('<a href="admin_role.html?id=' + oData.id + '">' + oData.role + '</a>');
                }
                switch (oData.status) {
                    case '0':
