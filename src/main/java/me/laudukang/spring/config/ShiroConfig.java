...
//    }
    ...
    public ShiroFilterFactoryBean adminShiroFilter() {
        ...
        filterChainDefinitionMapping.put("/admin/updatePassword", "authc,roles[MYADMININFO]");
        ...
        filterChainDefinitionMapping.put("/admin/newAdmin", "authc,perms[ADMIN:NEW]");
        ...
        filterChainDefinitionMapping.put("/admin/adminInfo/*", "authc,perms[ADMIN:QUERY,ADMIN:UPDATE]");
        filterChainDefinitionMapping.put("/admin/info", "authc,roles[MYADMININFO]");
        filterChainDefinitionMapping.put("/admin/admins", "authc,perms[ADMIN:QUERY]");
        filterChainDefinitionMapping.put("/admin/updateAdminRole", "authc,roles[Administrator]");
        ...
        filterChainDefinitionMapping.put("/admin/deleteRole/*", "perms[ROLE:DELETE]");
